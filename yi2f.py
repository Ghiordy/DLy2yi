...
from Read_Spectraly1toF import *   # data set build
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('REDytoy1/yi2ftrainEp'+str(epocas)+'.png')
plt.savefig('REDytoy1/yi2ftrainEp'+str(epocas)+'.eps', dpi=500)
plt.show()

modely1.save_weights('modelosEntrenados/UNetYitoFep'+str(epocas)+'.h5')
...
if True:
    ...
    toSave = r'C:\Users\ghior\Documents\MATLAB\DeepApproachHtransformation\DeepLearning\10teamH\outY4yi'
    samples = 150
    hy_list = []
    hy1_list = []
    hy2_list = []
