# -*- coding: utf-8 -*-
"""
Created on Wed May 19 04:16:13 2021
...
from Read_Spectraly1ytoF import *   # data set build
...
BATCH_SIZE = 2; IMG_WIDTH = 256; IMG_HEIGHT = 128; L_bands    = 13; L_imput    = 13; split_v = 0.80
...
#-------------Net_model----------------------------------------------------------------
preWe = r'modelosEntrenados/UNetYitoFep750.h5'
modely1 = UNetL_test(input_size=(IMG_HEIGHT,IMG_WIDTH,L_bands),pretrained_weights=preWe)
#modely1 = UNetL_testYiY(input_size=(IMG_HEIGHT,IMG_WIDTH,L_bands))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('REDytoy1/yiy2ftrainEp'+str(epocas)+'.png')
plt.savefig('REDytoy1/yiy2ftrainEp'+str(epocas)+'.eps', dpi=500)
plt.show()

modely1.save_weights('modelosEntrenados/UNetYiYtoFep'+str(epocas)+'.h5')
...
if True:
    ...
    toSave = r'C:\Users\ghior\Documents\MATLAB\DeepApproachHtransformation\DeepLearning\10teamH\outY4yiy'
    samples = 150
    hy_list = []
    hy1_list = []
    hy2_list = []
